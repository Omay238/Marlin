...
#define STRING_CONFIG_H_AUTHOR "(Omay, Ender-3 Pro)" // Who made the changes.
// this is a modified version of thisiskeithb's template for the Ender-3 Pro, specifically for mine.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kp_LIST {  21.527,  21.527 }
    #define DEFAULT_Ki_LIST {   1.063,   1.063 }
    #define DEFAULT_Kd_LIST {  108.182,  108.182 }
  #else
    #define DEFAULT_Kp  21.527
    #define DEFAULT_Ki   1.063
    #define DEFAULT_Kd  108.182
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 0.770
  #define DEFAULT_bedKd 948.182
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, 2.53 }
...
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS -10 // probably not best to do this, but it was being difficult
...
#define X_STEPS_PER_MM 79.45
#define Y_STEPS_PER_MM 80
#define Z_STEPS_PER_MM 400.5
